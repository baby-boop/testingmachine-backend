...
public class IndicatorCustomTab {
    ...
    public IndicatorCustomTab(String parentId, String indicatorId, String customTabName, String groupName, String sideBarName, String sideBarType, String status, String messageText, String jsonId
