...
public class IsProcessMessage {
    ...
    public static boolean isErrorMessagePresent(WebDriver driver, String id, String code, String name, String systemName, String TestProcessType, String jsonId) {
        try {
            ...
            if (messageTitle.contains("warning")) {
                ...
                return processMessage(driver, "success", id, code, name, systemName, TestProcessType, jsonId );
            }   else if (messageTitle.contains("info")) {
                return processMessage(driver, "info", id, code, name, systemName, TestProcessType, jsonId );
            }
            return false;
        } catch (Exception e) {
    ...
    private static boolean processMessage(WebDriver driver, String type, String id, String code, String name, String systemName, String TestProcessType, String jsonId) {
        try {
