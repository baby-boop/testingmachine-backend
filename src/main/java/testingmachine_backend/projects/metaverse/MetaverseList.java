...
public class MetaverseList {
    ...
    private static void workingWithMainList(WebDriver driver,  String jsonId, String theadId, String customerName, String createdDate, String moduleId,
        ...
        for (MetadataDTO metaData : metaDataList) {
            ...
            WaitUtils.retryWaitForLoadToDisappear(driver, metaData.getModuleName(), metaData.getId(), metaData.getCode(), metaData.getName(), jsonId, "metaverse", totalCount, customerName, 3);
            WaitUtils.retryWaitForLoadingToDisappear(driver, metaData.getModuleName(), metaData.getId(), metaData.getCode(), metaData.getName(), jsonId, "metaverse", totalCount, customerName, 3);
