...
@Slf4j
public class JsonPersentHeader {

    private static final Logger LOGGER = Logger.getLogger(JsonPersentHeader.class.getName());

    private static final String DIRECTORY_PATH_PERCENT = BASE_DIRECTORY + "/percent/header";
    /**
    ...
    public static <T> void saveToSingleJsonFile(T dto, String jsonId) {
        ...
        String jsonFileName = DIRECTORY_PATH_PERCENT + File.separator + jsonId + "_header.json";
