...
import static testingmachine_backend.process.utils.ProcessPath.processTabElements;
...
public class ProcessWizardSection {
    ...
    public static void KpiWizardFunction(WebDriver driver, String id) {
        ...
        if(wizardTabpanelPaths != null){
            for (WebElement sectionPath : wizardTabpanelPaths) {
                ...
                processTabElements(driver, wizardFieldPath, id);
